...
public class M0802a extends AppCompatActivity  implements View.OnClickListener {
    ...
    private void setupViewcomponent() {
        ...
        b002 = (Button) findViewById(R.id.m0802_b002);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.m0802_b002:
                ...
                Toast.makeText(getApplication(), getString(R.string.m0802_t002), Toast.LENGTH_SHORT).show();
                music_set();
    ...
    private void setnowtime() {  //重新設定鬧鐘時間
        ...
        //-----------------
        date01.updateDate(years02, month02, days02);
        time01.setHour(hours02);
